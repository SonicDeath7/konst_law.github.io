          ...
          <div className="lg:col-span-5 relative mt-4 lg:mt-0 flex justify-center">
            ...
            <div className="relative w-full max-w-md mx-auto">
              ...
              <div className="relative bg-[#111a2e] border border-slate-700/80 rounded-3xl overflow-hidden shadow-2xl p-2">
                ...
                {/* Portrait Image */}
                <div className="relative aspect-[3/4] rounded-2xl overflow-hidden bg-slate-900 flex items-center justify-center">
                  <img
                    src={LAWYER_INFO.photoUrl || '/images/photo.jpg'}
                    onError={(e) => {
                  ...
                  <div className="absolute bottom-4 left-4 right-4 p-3 rounded-xl bg-slate-900/90 backdrop-blur-md border border-slate-700/80 shadow-lg">
